...
namespace BodyCompositionCalculator.Helper_Classes.Extension_Classes
{
    public static class HttpPostedFileBaseExtensions
    {
        ...
        public static bool IsFileSizeLessThan(this HttpPostedFileBase postedFile, int maxBytes)
        {
            try
            {
